...
function library:CreateSettingsTab(menu)
    ...
    creditsSection:AddText({text = "LX.OWNER"})
    creditsSection:AddText({text = "LX.OWNER's PC"})
    creditsSection:AddSeparator({text = 'Websites'});
    creditsSection:AddText({text = "https://lxstore.netlify.app/"})
    creditsSection:AddText({text = "https://lxcracks.netlify.app/"})
